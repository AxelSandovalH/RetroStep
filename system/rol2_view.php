    ...
    ?>
        <div class="sneaker-card">
            ...
            <div class="sneaker-actions">
                <!-- <a class="link_editar" href="" onclick="return confirm('No tienes los permisos para editar registros');">
                    <button class="editar">Editar</button>
                </a>
                <a class="link_borrar" href="" onclick="return confirm('No tienes los permisos para eliminar registros');">
